...
We plan to support more languages in the future. If you'd like to add a new language, please contact the team first.
...
If you want to add support for a language not currently listed:

1. Contact the TrucklineMP team on Discord
2. We'll evaluate demand and maintenance feasibility
3. If approved, we'll add the locale to `astro.config.mjs`
4. You can then start translating the core guides
